...
{
    public static Vector3 GetPoint(this SplineContainer splineContainer, int splineIndex, float progress, out Vector3 forward, out Vector3 up)
    {
    ...
    public static Vector3 GetClosestEndPoint(this SplineContainer splineContainer, Vector3 position, out float progress, out Vector3 forward, out Vector3 up, out float distance)
    {
        Vector3 end1 = splineContainer.GetPoint(0, 0f, out Vector3 forward1, out Vector3 up1);
        Vector3 end2 = splineContainer.GetPoint(0, 1f, out Vector3 forward2, out Vector3 up2);
    ...
    public static List<List<Vector3>> GetVerts(this SplineContainer splineContainer, List<Vector3> offsets, int resolution, float portion = 1f) //FIX - rename or refactor maybe
    {
